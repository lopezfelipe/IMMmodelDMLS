...
% equations to find the steady-state location of isotherms in laser
...
%
% Example:
% [T_ss,y_ss,d_T,width] = LPBFsteady(195,0.800,0.6,1.0,5,false)
%
...
% 07/08/2016    Removed mu from equations for liquid phase.
%

function [T_ss,y_ss,d_T,width] = LPBFsteady(P,v,A,mu,n1,plot_flag)
...
c1 = (T-T_0)*2*pi*rho_*Cp_*alpha_0/A/P;
c2 = 2*alpha_0/v;
